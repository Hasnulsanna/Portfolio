      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center space-x-12 mb-12">
          <motion.h2
            ...
            className={`text-2xl font-semibold cursor-pointer transition relative ${
              activeTab === 'experience' ? 'text-blue-600 border-b-4 border-blue-600' : 'text-gray-700'
            }`}
          ...
          <motion.h2
            ...
            className={`text-2xl font-semibold cursor-pointer transition relative ${
              activeTab === 'education' ? 'text-blue-600 border-b-4 border-blue-600' : 'text-gray-700'
            }`}
            whileHover={{ scale: 1.1 }}
          >
            Education
              ...
              ? experiences.map((exp, index) => (
                  ...
                  >
                    ...
                    <motion.div whileHover={{ scale: 1.02 }} className="bg-white rounded-lg shadow-md p-6">
                      ...
                      <p className="text-sm text-blue-500 mt-1">{exp.period}</p>
              ...
              : education.map((edu, index) => (
                  ...
                  >
                    ...
                    <motion.div whileHover={{ scale: 1.02 }} className="bg-white rounded-lg shadow-md p-6">
                      ...
                      <p className="text-sm text-blue-500 mt-1">{edu.period}</p>
