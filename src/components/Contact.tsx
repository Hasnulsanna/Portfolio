    ...
    <section id="contact" className="py-20 bg-gray-50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-600">hasnulsanna7@gmail.com</span>
                </div>
                <div className="flex items-center">
                  <Phone className="w-5 h-5 text-blue-600 mr-3" />
                  <span className="text-gray-600">+91 87141 51942</span>
                </div>
                <div className="flex items-center">
            ...
            >
              ...
              <div className="flex justify-center space-x-6">
                <a href="https://github.com/Hasnulsanna" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition">
                  <Github className="w-6 h-6" />
                </a>
                <a href="https://www.linkedin.com/in/hasnul-sanna-075499273" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition">
                  <Linkedin className="w-6 h-6" />
                </a>
                <a href="mailto:hasnulsanna7@gmail.com" className="hover:text-blue-400 transition">
      ...
      <footer className="bg-gray-900 text-white py-6 mt-16">
        <div className="container mx-auto px-4 text-center">
          <p className="text-gray-400 text-sm">Designed & Built by Hasnul Sanna</p>
